...
const emailOlvidePassword = async (datos) => {
    ...
    const transport = nodemailer.createTransport({
      ...
      const info = await transport.sendMail({
        from : "ADAM",
        to: email,
        subject : 'Recuperar Contraseña - ADAM',
        text : "Recuperar Contraseña - ADAM",
        html: `        
                 ...
                 <tr style="border-collapse:collapse">
                  <td align="left" class="es-m-p20b" style="padding:0;Margin:0;width:522px">
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr style="border-collapse:collapse">
                      <td align="center" style="padding:0;Margin:0"><h1 style="Margin:0;line-height:59px;mso-line-height-rule:exactly;font-family:Poppins, sans-serif;font-size:49px;font-style:normal;font-weight:bold;color:#00413f"><span style="font-size:39px">Restablecer</span> <span style="font-size:39px">Contraseña</span></h1></td>
                     </tr>
                     <tr style="border-collapse:collapse">
                      <td align="center" style="Margin:0;padding-left:5px;padding-right:5px;padding-top:10px;padding-bottom:10px"><h3 style="Margin:0;line-height:26px;mso-line-height-rule:exactly;font-family:Poppins, sans-serif;font-size:22px;font-style:normal;font-weight:bold;color:#333333">${nombre}<br></h3><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333;font-size:15px"><br></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333;font-size:15px">Has solicitado restablecer tu contraseña.</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;line-height:23px;color:#333333;font-size:15px">Sigue el siguiente enlace, para restablecer tu contraseña:</p></td>
                     </tr>
                     <tr style="border-collapse:collapse">
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="http://186.10.115.124:3113/evidence-center?eid=009901A68" 
                style="height:39px; v-text-anchor:middle; width:228px" arcsize="13%" stroke="f"  fillcolor="#811301">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:roboto, "helvetica neue", helvetica, arial, sans-serif; font-size:14px; font-weight:400; line-height:14px;  mso-text-raise:1px'>Restablecer Contraseña</center>
	</v:roundrect></a>
<![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border-1720808126610 es-button-border" style="border-style:solid;border-color:#00C4C6;background:#811301;border-width:0px;display:inline-block;border-radius:5px;width:auto;mso-hide:all"><a href ="${process.env.FRONTEND_URL}/olvide-password/${token}" class="es-button es-button-1720808126603" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:16px;display:inline-block;background:#811301;border-radius:5px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center;padding:10px 20px 10px 20px;mso-padding-alt:0;mso-border-alt:10px solid #811301">Restablecer Contraseña</a></span><!--<![endif]--></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
